...
public class FarmerPutPayload implements Streamable {
	...
	public FarmerPutPayload(Bytes32 launcherId, NativeUInt64 authenticationToken, Bytes48 authenticationPublicKey, String payoutInstructions, NativeUInt64 suggestedDifficulty) {
